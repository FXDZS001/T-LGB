...
data_dir   = r"D:\fog_prediction\data\ec高空\数据"      
label_dir  = r"D:\fog_prediction\data\ec高空\ViT_label\总站\低\label"  
...
plt.show()
print(f"[SAVE] t-SNE 可视化已保存: {out_path}")
